  ...
  return (
    <main style={{ background: "#080c10", minHeight: "100vh", color: "#ffffff", fontFamily: "var(--font-dm-sans)" }}>
      ...
      <div style={{ padding: "0 1.25rem 3rem", maxWidth: "960px", margin: "0 auto" }}>
        ...
        <div style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "12px", padding: "3rem", textAlign: "center", marginBottom: "2rem" }}>
        ...
        {/* What is a break */}
        <div style={{ background: "rgba(240,180,41,0.06)", border: "1px solid rgba(240,180,41,0.15)", borderRadius: "12px", padding: "1.5rem 2rem" }}>
