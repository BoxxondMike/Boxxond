      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "2rem" }}>
        <div style={{ width: "100%", maxWidth: "400px" }}>
          ...
          <div style={{ marginBottom: "2rem", textAlign: "center" }}>
            ...
            <p style={{ color: "rgba(255,255,255,0.4)", fontSize: "14px", margin: 0 }}>Log in to your Boxxond account</p>
          </div>
          ...
          <p style={{ textAlign: "center", fontSize: "13px", color: "rgba(255,255,255,0.4)", marginTop: "1.5rem" }}>
            ...
            <Link href="/signup" style={{ color: "#f0b429", textDecoration: "none" }}>Sign up free</Link>
          </p>
