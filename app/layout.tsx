  ...
  <div style={{ maxWidth: "960px", margin: "0 auto" }}>
    ...
    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap" as const, gap: "2rem", marginBottom: "2.5rem" }}>
      ...
      <div style={{ display: "flex", gap: "4rem", flexWrap: "wrap" as const }}>
        <div>
          <div style={{ fontSize: "11px", color: "rgba(255,255,255,0.3)", textTransform: "uppercase" as const, letterSpacing: "1px", marginBottom: "1rem", fontFamily: "var(--font-dm-sans)", fontWeight: 700 }}>Explore</div>
          <div style={{ display: "flex", flexDirection: "column" as const, gap: "0.6rem" }}>
            ...
            <Link href="/breaks" style={{ fontSize: "14px", color: "rgba(255,255,255,0.5)", textDecoration: "none" }}>Live Breaks</Link>
            <Link href="/dashboard" style={{ fontSize: "14px", color: "rgba(255,255,255,0.5)", textDecoration: "none" }}>Dashboard</Link>
          </div>
        </div>

        <div>
          <div style={{ fontSize: "11px", color: "rgba(255,255,255,0.3)", textTransform: "uppercase" as const, letterSpacing: "1px", marginBottom: "1rem", fontFamily: "var(--font-dm-sans)", fontWeight: 700 }}>Soccer</div>
          <div style={{ display: "flex", flexDirection: "column" as const, gap: "0.6rem" }}>
        ...
        <div>
          <div style={{ fontSize: "11px", color: "rgba(255,255,255,0.3)", textTransform: "uppercase" as const, letterSpacing: "1px", marginBottom: "1rem", fontFamily: "var(--font-dm-sans)", fontWeight: 700 }}>Other Sports</div>
          <div style={{ display: "flex", flexDirection: "column" as const, gap: "0.6rem" }}>
        ...
        <div>
          <div style={{ fontSize: "11px", color: "rgba(255,255,255,0.3)", textTransform: "uppercase" as const, letterSpacing: "1px", marginBottom: "1rem", fontFamily: "var(--font-dm-sans)", fontWeight: 700 }}>Legal</div>
          <div style={{ display: "flex", flexDirection: "column" as const, gap: "0.6rem" }}>
            <Link href="/privacy" style={{ fontSize: "14px", color: "rgba(255,255,255,0.5)", textDecoration: "none" }}>Privacy Policy</Link>
            <Link href="/terms" style={{ fontSize: "14px", color: "rgba(255,255,255,0.5)", textDecoration: "none" }}>Terms of Service</Link>
          </div>
        </div>
      </div>

      <div>
        <div style={{ fontSize: "11px", color: "rgba(255,255,255,0.3)", textTransform: "uppercase" as const, letterSpacing: "1px", marginBottom: "1rem", fontFamily: "var(--font-dm-sans)", fontWeight: 700 }}>Follow Us</div>
    ...
    <div style={{ borderTop: "1px solid rgba(255,255,255,0.06)", paddingTop: "1.5rem", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap" as const, gap: "1rem" }}>
