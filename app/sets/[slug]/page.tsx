...
'topps-finest-premier-league-2026': {
  ...
  year: '2026',
  difficulty: 'Premium',
  overview: 'Topps Finest makes its Premier League debut in 2026. The premium refractor based set brings its stunning atomic refractors and guaranteed on card autographs to English football for the first time. Available from 23rd April 2026, this is one of the most anticipated football card releases of the year.',
  whatToLookFor: 'Atomic refractor parallels are the signature cards of the Finest brand. On card autographs of Premier League stars are guaranteed in hobby boxes. Look for rookie Finest cards of breakout Premier League players and numbered parallels of established stars.',
  parallels: [
    { name: 'Base Refractor', printRun: 'Unlimited', colour: 'Silver' },
    { name: 'Atomic Refractor', printRun: 'Limited', colour: 'Rainbow' },
    { name: 'Blue Refractor', printRun: '/150', colour: 'Blue' },
  ...
  tips: [
    'First ever Finest Premier League release — expect strong demand at launch on 23rd April',
    'Atomic refractors are the most eye catching cards in the set',
    'On card autos are guaranteed in hobby boxes making it great value for auto hunters',
    'Buy early — launch prices for new Finest releases often represent the best value',
  ],
  priceRange: 'From £10 to £2,000+',
},
};
