...
const sports: Sport[] = [
  ...
  checklistUrl: 'https://cdn.shopify.com/s/files/1/0739/2015/1805/files/Finest_Premier_League_Checklist.pdf?v=1774359572',
},
      {
        ...
        checklistUrl: 'https://www.beckett.com/news/panini-prizm-premier-league-soccer/',
      },
       {
      ...
      },
      {
        ...
        checklistUrl: 'https://www.beckett.com/news/topps-chrome-sapphire-soccer/',
      },
      {
        slug: 'topps-finest',
        name: 'Topps Finest',
        ...
        checklistUrl: 'https://www.beckett.com/news/topps-finest-soccer/',
      },
      {
        ...
        checklistUrl: 'https://www.beckett.com/news/topps-gold-label-soccer/',
      },
      {
        slug: 'topps-now',
        name: 'Topps NOW',
  ...
  },
  {
    ...
    sets: [
      ...
      },
      {
        ...
        checklistUrl: 'https://cdn.shopify.com/s/files/1/0662/9749/5709/files/2025-26_Topps_Cosmic_Chrome_Basketball_Checklist.pdf?v=1774549583',
      },
      {
    ...
    sets: [
      {
        ...
        checklistUrl: 'https://uk.topps.com/pages/baseball',
      },
      {
        slug: 'topps-baseball',
        name: 'Topps Baseball',
